...
Provides REST API endpoints for seamless Astron-RPA integration,
...
@rpa_integration_router.get("/components/mapping", response_model=Dict[str, Any])
async def get_component_mapping() -> Dict[str, Any]:
